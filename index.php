...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-6 d-flex align-items-center">
                    <div class="mx-3">
                        ...
                        <a href=<?= $username ? "profil.php" : "#login" ?> class="btn btn-outline-dark mt-3" style="background-color: rgb(140, 186, 159);">Explore Now !</a>
                    </div>
                </div>
    ...
    <footer class="px-4 pt-4">
        ...
        <div class="mt-3 pb-3 text-center">&copy;2024 by Nikita & Bintang</div>
    </footer>
